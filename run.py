...
def get_sales_data():
    ...
    via the terminal, which must be string of 6 numbers seperated by 
...
def validate_data(values):
    ...
    Raises ValueError if string cannot be coverted into int,
...
def calculate_surplus_data(sales_row):
    """
    Compare Sale and Stock and calculate surplus for each item type,

    The surplus is defined as the sales figure subtracted from the stock:
    -Positive surplus indicates waste
    -Negative surplus indicates extra made when the stock sold out 
    """
